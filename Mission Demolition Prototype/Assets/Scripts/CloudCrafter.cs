...
public class CloudCrafter : MonoBehaviour {
	...
	public Vector3			cloudPosMin;			// Minimum position of each cloud
	public Vector3			cloudPosMax;			// Max position of each cloud
	public float			cloudScaleMin = 1;		// Minimum scale of each cloud
	public float			cloudScaleMax = 5;		// Maximum scale of each cloud
	[Tooltip("Affects speed of clouds")]
	...
	void Awake() {
		...
		for (int i = 0; i < numClouds; i++)
		{
			...
			// Add the clooud to cloudInstances
